...
3. Invoke the workflow `$FORGE_HOME/workflows/feature-pipeline.js` with
   ...
   to a JSON file and run `node "$FORGE_HOME/bin/forge-run.mjs" feature-pipeline --args-file <file>`
